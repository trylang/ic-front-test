...
export class ShareComponent implements OnChanges, AfterViewInit {
  private siteName: string = '创新中心'; // Website name
  private title: string; // header title
  private url: string;
  private summary: string; //
  private desc: string = '分享自@创新中心'; // default share reason
  ...
  public ngOnChanges(changes: { [propKey: string]: SimpleChange }) {
    ...
    if (changes['shareDesc'] && changes['shareDesc'].currentValue) {
