(function() {
  ...
  var tracker = {
    ...
    clientConfig: {
      ...
      serverUrl: location.host +'/transfer.gif',
      // serverUrl: 'http://192.168.1.203:88/transfer.gif',
    ...
    columns: {
      // 发送到服务器的列名称
      eventName: 'en', // 事件名称，URL事件，收藏事件，订阅事件
      ...
      language: 'l', // 语言
      userAgent: 'b_iev', // 浏览器信息
      resolution: 'b_rst', // 分辨率
      currentUrl: 'p_url', // 当前页面URL
      referrerUrl: 'p_ref', // 前一个页面URL
      title: 'tt', // 浏览器顶部 tab title
      userId: 'u_id', // 用户id
    ...
    sendDataToServer: function(data) {
      ...
      i2.onerror = function() {
        // 这里可以进行重试操作
        console.warn('ERROR: ', 'Something wrong');
      };
